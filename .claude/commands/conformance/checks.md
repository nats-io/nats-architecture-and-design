...
There must be a conformance rules file in `conformance/ADR-xxx.md` or `conformance/ADR-xxx-subset.md` that describes the requirements for the test.
The user will say something like write conformance tests for "ADR-xxx" and you must find the conformance rules in `conformance/ADR-xxx.md`.  If not 
stop, tell the user to run the /conformance:rules command first.

# Step 2: Conformance Checks

- Read the conformance rules in `conformance/ADR-xxx.md` or `conformance/ADR-xxx-subset.md`
